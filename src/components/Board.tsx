    ...
    <div className="relative mx-4">
      ...
      <div className="bg-white dark:bg-black transition-colors duration-1000 px-10 pt-16 pb-12 border-8 border-primary space-y-7 3xl:px-16 3xl:pt-20 3xl:pb-16">
        ...
        <div className="space-y-5">
          ...
          <input
            className="w-full outline-none border border-lightGrey rounded-md px-4 py-3 text-lg 3xl:text-2xl 3xl:px-6 3xl:py-6 "
            placeholder="email"
          />
          <button className="w-full py-3 bg-primary rounded-md text-white text-lg 3xl:text-2xl 3xl:py-6 transform transition-transform duration-300 hover:bg-primary hover:scale-105 hover:shadow-lg ">
            Subscribe
          </button>
        </div>
      </div>
